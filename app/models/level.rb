...
models_directory = './app/models' # Update this path to your models directory

# Initialize the model_files hash
model_files = {}

# Use Dir to find all .rb files in the directory and subdirectories
Dir.glob("#{models_directory}/**/*.rb").each do |file|
  model_files[File.basename(file)] = File.read(file)
end

# Debug: Print out the loaded files
puts model_files